...
namespace Extensions
{
	...
	public:
		...
		std::error_code CreateInstance(module::guid const& clsid, module::guid const& riid, void** ppv);
		std::error_code CreateInstance(module::guid const& riid, void** ppv);
